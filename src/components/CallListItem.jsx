...
const CallListItem = ({index,name, duration, time, status, callDirection}) => {
    ...
    //console.log(name, duration, time, status, callDirection)
    const navigation = useNavigation()
    //const call_dateTime = time?time.toDate().toString():null;
    ...
    const [isNoon, set_isNoon] = useState(false);
     ...
     const calculateDay = () => {
        ...
        //console.log('date- (new Date().toDateString())',(currentDay-ts)/millisecondsInDay)
